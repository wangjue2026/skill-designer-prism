...
| **二** | **标杆经验学习与设计选型** | 汇流 Step 2：业务严肃度定性、对应类型（如 Type-07）标杆案例经验传承矩阵（明确复用哪几条 `EP-xx` 经验及样式/解法）、专家范式（`P-01~08`）。 |
...
<div class="wrap">
  <div class="doc">
    ...
    <h3>2. 标杆案例经验传承矩阵 (从 Type-xx 萃取)</h3>
    <table>
      <thead><tr><th>经验编号</th><th>经验名称与解法</th><th>对齐产线</th><th>裁决定位</th><th>在本方案中的继承落地与 Why 因果</th></tr></thead>
      <tbody>
        <tr>
          ...
          <td>XDR / SASE</td>
          <td><b>【首选基线】</b></td>
          <td>下发巡检任务采用右侧抽屉而非跳页，用户保持在列表主视线内，降低跳页认知损耗。</td>
        </tr>
        <tr>
          ...
          <td>XDR</td>
          <td><b>【体验推荐】</b></td>
          <td>选择部门/标签后动态计算命中终端总数、在线数、离线数，消除配置盲盒心理。</td>
        </tr>
        <tr>
          ...
          <td>XDR / SASE / aES</td>
          <td><b>【首选基线】</b></td>
          <td>进度条实时展现完成/违规/跳过台数，超过 10 分钟超时自动标记熔断，防死信挂死。</td>
        </tr>
        <tr>
          ...
          <td>XDR / SASE</td>
          <td><b>【首选基线】</b></td>
          <td>点击终端弹出右侧体检单抽屉，包含必装软件核对与违规进程路径，拒绝跳页断流。</td>
        </tr>
        <tr>
          ...
          <td>SASE</td>
          <td><b>【首选基线】</b></td>
          <td>普通违规弱提醒弹窗引导自愈；高危违规联动零信任动态阻断内网访问，兼顾体验与安全。</td>
        </tr>
      </tbody>
    </table>
